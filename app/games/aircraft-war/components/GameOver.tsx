...
export function GameOver({ score, highScore, isNewRecord, onRestart, onMenu }: GameOverProps) {
  return (
    <div className="absolute inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center rounded-xl">
      <div className="bg-gray-900/95 p-8 rounded-2xl shadow-2xl w-80 text-white">
        ...
        <div className="space-y-3 mb-6">
          <div className="flex justify-between items-center">
            <span className="text-gray-300">击落敌机</span>
            <span className="text-2xl font-bold text-yellow-400">{Math.floor(score / 10)}</span>
          </div>
          <div className="flex justify-between items-center">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-2xl font-bold text-gray-300">{highScore}</span>
          </div>
        </div>
