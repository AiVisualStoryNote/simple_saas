...
export default function SnakeGame() {
  ...
  const canvasSize = 20 * 20; // GAME_CONFIG.gridSize * cellCount
      ...
      <div className="relative max-w-[420px] w-full">
        {gameState === "menu" && (
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl text-center text-white">
            <div className="mb-6">
              <h1 className="text-5xl font-bold mb-3 bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent">
                贪吃蛇
              </h1>
              <p className="text-gray-300 text-lg">
                {isZh ? "经典街机小游戏" : "Classic Arcade Game"}
              </p>
            </div>
            ...
            <button
              onClick={startGame}
              className="bg-gradient-to-r from-green-500 to-cyan-500 hover:from-green-600 hover:to-cyan-600 text-white text-xl font-bold px-12 py-4 rounded-full shadow-xl transition-transform hover:scale-105 active:scale-95"
            >
              🎮 开始游戏
            </button>
            {highScore > 0 && (
